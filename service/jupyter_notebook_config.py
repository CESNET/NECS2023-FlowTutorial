...
#  local as well.
#c.NotebookApp.local_hostnames = ['0.0.0.0']
...
#c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$qQTdf6fw8KEwp0eib/8jeA$0m+PS6nnLK8ZdOVWC03v2lSg8c7K0wQT47hTGcHYWzs'
